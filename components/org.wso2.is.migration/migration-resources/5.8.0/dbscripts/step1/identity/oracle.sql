...
CREATE OR REPLACE PROCEDURE add_column_if_not_exists (query IN VARCHAR2)
  IS
BEGIN
...
CALL add_column_if_not_exists('ALTER TABLE IDN_OAUTH2_AUTHORIZATION_CODE ADD IDP_ID INTEGER DEFAULT -1 NOT NULL')
/

CALL add_column_if_not_exists('ALTER TABLE IDN_OAUTH2_ACCESS_TOKEN ADD IDP_ID INTEGER DEFAULT -1 NOT NULL')
/

CALL add_column_if_not_exists('ALTER TABLE IDN_OAUTH2_ACCESS_TOKEN_AUDIT ADD IDP_ID INTEGER DEFAULT -1 NOT NULL')
/
...
IS
  BEGIN
    ...
    begin
      ...
      IF (column_count > 0)
      THEN
        execute immediate 'ALTER TABLE IDN_OAUTH2_ACCESS_TOKEN DROP CONSTRAINT CON_APP_KEY DROP INDEX';
